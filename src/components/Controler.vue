<template>
  <div class="wraper-controler">
            <button v-on:click="newGame"
             class="control btn-new"><i class="fa-regular fa-square-plus"></i>New game</button>
            <button v-on:click="rollDice"
            class="control btn-roll"><i class="fa-solid fa-dice"></i>Roll dice</button>
            <button v-on:click="holdScore"
            class="control btn-hold"><i class="fa-sharp fa-solid fa-circle-down"></i>Hold</button>
            <input v-bind:disabled="isPlaying ? true : false"
